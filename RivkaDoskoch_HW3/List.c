...
// Output:	TRUE if succeeded
//////////////////////////////////////////////////////////////
BOOL L_deleteAndFreeNode(NODE* pNode)
{
	NODE* tmp;
...
//////////////////////////////////////////////////////////////
/// Delete without free
// Aim:		erase node from the list
// Input:	pointer to the node BEFORE the node to be deleted from the list
// Output:	TRUE if succeeded
//////////////////////////////////////////////////////////////
...
BOOL L_free(LIST* pList)
{
	...
	for (tmp = &(pList->head); L_deleteAndFreeNode(tmp); );
	return True;
}
...
int L_print(LIST* pList, void(*print)(void *))
{
